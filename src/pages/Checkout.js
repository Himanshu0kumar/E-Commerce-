...
function Checkout() {
  ...
  const handleOrder = (e) => {
    const order = {
      ...
      paymentMethod,
      selectedAddress,
      status: 'pending' // it can be changed after deliver the product by admine 
    };
    dispatch(createOrderAsync(order));

    // TODO: Redirect to order successful
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto bg-slate-300 max-w-7xl px-2 sm:px-2 lg:px-2">
              <div className="mt-8">
