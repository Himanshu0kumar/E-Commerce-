...
import { EyeIcon, PencilIcon , ArrowUpIcon,ArrowDownIcon } from "@heroicons/react/16/solid";
              ...
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  <th className="py-3 px-6 text-left cursor-pointer"  onClick={(e) =>
                    ...
                    {sort._sort === 'id' && (sort._order === 'asc' ? ( <ArrowUpIcon className="h-4 w-4 inline"></ArrowUpIcon>)
                  ...
                  <th className="py-3 px-6 text-left cursor-pointer"  onClick={(e) =>
                    ...
                    {sort._sort === 'totalAmount' && (sort._order === 'asc' ? ( <ArrowUpIcon className="h-4 w-4 inline"></ArrowUpIcon>)
                    : (<ArrowDownIcon className="h-4 w-4 inline"></ArrowDownIcon>))}
                    </th>
